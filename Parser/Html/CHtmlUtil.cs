...
// CHtmlUtil.cs: implementation of the CHtmlUtil class.
//
///////////////////////////////////////////////////////////////////////////////
...
namespace Cloud9.Parser.Html
{
    ...
    #region 
        ...
        public static string TransformValidXHtmlString(string str)
        {
            ...
            while(read != -1)			
            {
                ...
                else builder.Append("&#" + ((int)read).ToString() + ";"); 
    ...
    #region 
        ...
        public static string MakePathFromSegment(Uri uri)
        {
            string result = uri.Scheme + "://" + uri.Host + uri.PathAndQuery;
            return result;
        }

...
namespace Cloud9.Parser.Html.Css
{
    ...
    /// 
	/// </summary>
    public sealed class DCssSelector : Cloud9.Parser.Html.Base.IDiagnosisable, IEnumerable, ICloneable, IEquatable<DCssSelector>, IComparable<DCssSelector>
	{
    ...
    #region ㆁ뱄앵?
        ...
        /// <returns></returns>
        public CHtmlNodeCollection SearchMatching(CHtmlNodeCollection nodes)
        {
        ...
        /// <returns></returns>
        public CHtmlNodeCollection SearchMatching(CHtmlNodeCollection nodes, bool searchChildren)
        {
            System.Diagnostics.Debug.Assert(nodes != null);
            CHtmlNodeCollection result = new CHtmlNodeCollection();

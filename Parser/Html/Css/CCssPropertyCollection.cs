...
namespace Cloud9.Parser.Html.Css
{
    ...
    /// </summary>
    public sealed class DCssPropertyCollection : Cloud9.Parser.Html.Base.IDiagnosisable, IEnumerable
    {
    ...
    #region ±âº»
        ...
        public void Dump(StringBuilder buffer, string prefix)
        {
            ...
            if(m_propertyList.Count != 0)
            {
                ...
                for(int index = 0, count = m_propertyList.Count; index < count; ++index) // ©Ò¦³ª«¥ó´M³X?¦¸©I¥s Dump
                {

...
{
    public sealed class DCssSimpleSelector : ICloneable, IComparable<DCssSimpleSelector>, IEquatable<DCssSimpleSelector>, Cloud9.Parser.Html.Base.IDiagnosisable
    {

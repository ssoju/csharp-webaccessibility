...
namespace Cloud9.Threading
{
   ...
   public class WorkItemEventArgs : EventArgs
   {
      ...
      /// <summary>
      ///   Gets the <see cref="Cloud9.Threading.WorkItem"/> associated with the event.
      /// </summary>
      /// <value>
      ///   The <see cref="Cloud9.Threading.WorkItem"/> that caused the event.
      /// </value>

...
namespace DockWindow
{
	...
	public class DockWindow : System.Windows.Forms.Form
	{
		...
		/// </summary>
		[Category("DockWindow"), Description("Gets or sets the dock element type.")]
		...
		/// </summary>
		[Category("DockWindow"), Description("Allow this window to be undocked.")]
		...
		/// </summary>
		[Category("DockWindow"), Description("Allow this window to be closed.")]
		...
		/// </summary>
		[Category("DockWindow"), Description("Allow other windows or containers to dock into this one.")]
		...
		/// </summary>
		[Category("DockWindow"), Description("Allow other windows to split the control container.")]
		...
		/// </summary>
		[Category("DockWindow"), Description("Allow the framework to save and restore the window position.")]
		...
		/// </summary>
		[Category("DockWindow"), Description("Gets or sets a flag that prevents the window from closing.")]
